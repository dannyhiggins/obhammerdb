...
proc countmysqlopts { bm } {
    ...
    # OceanBase variables for TPC-C
    if {![info exists mysql_tpcc_obcompat]} {
        set mysql_tpcc_obcompat "false"
    }
...
proc configmysqltpcc {option} {
	...
	grid $Prompt -column 0 -row 19 -sticky e
        ...
        ttk::checkbutton $Name -text "" -variable mysql_tpcc_obcompat -onvalue "true" -offvalue "false"
        grid $Prompt -column 0 -row 21 -sticky e
        grid $Name -column 1 -row 21 -sticky w
        bind $Parent.f1.e11a <Button> {
